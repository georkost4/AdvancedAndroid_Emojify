...
class Emojifier {
    ...
    private static final float smilingThreshold = 0.5f;
    private static final float winkingThreshold = 0.75f;
    ...
    private static void whichEmoji(Face face){
        ...
        boolean leftEyeClosed = face.getIsLeftEyeOpenProbability()<winkingThreshold;
        boolean rightEyeClosed = face.getIsRightEyeOpenProbability()<winkingThreshold;
        boolean smiling = face.getIsSmilingProbability()>smilingThreshold;
